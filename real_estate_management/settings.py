...
SECRET_KEY = 'django-insecure-cihw5npf2pfw-#(!0@q6e9rrrazhm(-_laofvjbyi16ar5@n6b'
...
INSTALLED_APPS = [
    ...
    "tenants",                 # Custom app for tenant management
    "leases",                  # Custom app for lease management
    "payments",                # Custom app for payments
    "maintenance",             # Custom app for maintenance requests
]
